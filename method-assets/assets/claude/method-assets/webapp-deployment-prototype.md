...
```json
{
  ...
  "environment": {
    ...
    "relationships": [
      {
        "from": "ci-spa-browser",
        "to": "infra-edge-gateway",
        "label": "Makes API calls to",
        "technology": "JSON/HTTPS",
        "mode": "sync"
      },
      {
        "from": "ext-agent-harness",
        "to": "infra-edge-gateway",
        "label": "Makes tool calls to",
        "technology": "MCP/HTTPS",
        "mode": "sync"
      },
      {
        "from": "infra-edge-gateway",
        "to": "infra-identity-provider",
        "label": "Authenticates the request against",
        "technology": "OIDC",
        "mode": "sync"
      },
      {
        "from": "infra-edge-gateway",
        "to": "ci-app-server",
        "label": "Forwards the authenticated request to",
        "technology": "HTTP",
        "mode": "sync"
      }
    ]
