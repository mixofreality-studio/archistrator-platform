...
| **D3 — composable design** | non-core use cases compose from existing components without new ones | the non-core dynamic views that draw cleanly (the variation call chains) |
...
| **D4 — features as integration** | a new feature is a new orchestration, not a new component | the dynamic views showing features emerging from interaction |
