...
4. **Test the component.** Write the component's Service Test Plan (STP) — the
   ...
   black-box tests against the STP. The system and regression test harness is
   generated by the platform — it is not an activity anyone builds. No
   BDD/Gherkin. See [[the-method-testing]].
